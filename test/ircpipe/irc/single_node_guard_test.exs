defmodule Ircpipe.Irc.SingleNodeGuardTest do
  ...
  test "a real visible peer keeps IRC disabled without restarting the application" do
    ...
    peer_name = :ircpipe_single_node_guard_peer
  ...
  defp start_distribution do
    if Node.alive?() do
      ...
      assert {:ok, _pid} = :net_kernel.start([:ircpipe_single_node_guard_origin, :shortnames])
      true
    end
  end
