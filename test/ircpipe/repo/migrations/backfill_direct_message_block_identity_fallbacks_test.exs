defmodule Ircpipe.Repo.Migrations.BackfillDirectMessageBlockIdentityFallbacksTest do
  use ExUnit.Case, async: false

  alias Ircpipe.MigrationTestRepo

  alias Ircpipe.Repo.Migrations.BackfillDirectMessageBlockIdentityFallbacks,
    as: BackfillMigration

  alias Ircpipe.Repo.Migrations.RepairDirectMessageIdentityBackfillTracking,
    as: RepairMigration
  ...
  test "repairs an already-applied empty development database without breaking rollback" do
    prefix =
      "dm_identity_repair_'$$$ircpipe_migration_0$quoted_#{System.unique_integer([:positive])}"
