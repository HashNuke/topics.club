defmodule TopicsClub.Engine.APITest do
  ...
  alias TopicsClub.Engine.LocalAdapter
  ...
  test "a failed process stop keeps paused intent and can be retried", %{
    ...
    pid =
      start_supervised!(%{
        ...
        start: {TopicsClub.CrashingIrcSession, :start_link, [connection]},
        restart: :temporary
      })
    ...
    assert Repo.get!(TopicsClub.Chat.ServerConnection, connection.id).desired_state == "paused"
