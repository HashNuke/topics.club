defmodule TopicsClub.NotificationsTest do
  ...
  alias TopicsClub.Notifications.{
    Delivery,
    Preferences,
    PushSubscription,
    PushRegistrations,
  ...
  setup do
    ...
    Application.put_env(:topics_club_gateway, :push_sender, TopicsClub.PushTestTransport)
  ...
  test "delivers direct-message payloads and suppresses blocked peers", %{
    ...
    message_count = Repo.aggregate(TopicsClub.Chat.Message, :count)
    ...
    assert Repo.aggregate(TopicsClub.Chat.Message, :count) == message_count
