defmodule TopicsClub.Chat.PresenceMembershipLookupTest do
  ...
  setup do
    ...
    {:ok, equivalent_membership} = TopicsClub.Chat.join_channel(user, connection, "#[ops]")
    {:ok, other_membership} = TopicsClub.Chat.join_channel(user, connection, "#other")
