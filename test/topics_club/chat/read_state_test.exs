defmodule TopicsClub.Chat.ReadStateTest do
  ...
  test "marks owned channel and server buffers read" do
    ...
    {:ok, membership} = TopicsClub.Chat.join_channel(user, connection, "#elixir")
  ...
  test "rejects buffers owned by another user" do
    ...
    {:ok, membership} = TopicsClub.Chat.join_channel(owner, connection, "#elixir")
  ...
  test "rejects forged server connection ownership" do
    ...
    Phoenix.PubSub.subscribe(TopicsClub.PubSub, "user:#{other_user.id}")
