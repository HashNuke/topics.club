defmodule TopicsClub.Irc.Session.OutboundMessagesTest do
  ...
  alias TopicsClub.Irc.Session.{OutboundMessages, PendingEchoes}
  ...
  defp connected_state(channel) do
    ...
    assert_receive {:irc_server_line, "NICK topics_club"}
    assert_receive {:irc_server_line, "USER topics_club 0 * topics_club"}
