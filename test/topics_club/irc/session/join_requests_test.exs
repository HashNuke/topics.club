defmodule TopicsClub.Irc.Session.JoinRequestsTest do
  use TopicsClub.DataCase, async: true

  alias TopicsClub.AccountsFixtures
  alias TopicsClub.Chat.{Connections, MembershipLookup, ServerConnection}
  ...
  test "persists and queues a join request while disconnected", context do
    ...
    persisted = Repo.get!(TopicsClub.Chat.ChannelMembership, membership.id)
