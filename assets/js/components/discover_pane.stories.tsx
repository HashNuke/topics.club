...
const activeServer: ServerConnection = {id: "server:1", server_connection_id: 1, name: "Libera.Chat", host: "irc.libera.chat", status: "connected", channels: []}
...
const meta = {title: "Discover/DiscoverPane", component: DiscoverPane, parameters: {layout: "fullscreen"}, decorators: [(Story) => <div className="flex h-[46rem] bg-[#090b10]"><Story /></div>], args: {activeServer, channels, onJoinChannel: () => {}, onJoinThisServer: () => {}}} satisfies Meta<typeof DiscoverPane>
export default meta
type Story = StoryObj<typeof meta>

export const AllServers: Story = {}
export const ThisServer: Story = {args: {initialTab: "server"}}
export const Loading: Story = {args: {channels: [], loading: true}}
export const EmptyCatalog: Story = {args: {channels: []}}
