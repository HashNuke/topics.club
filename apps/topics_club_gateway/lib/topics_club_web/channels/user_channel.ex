defmodule TopicsClubWeb.UserChannel do
  use TopicsClubWeb, :channel
  ...
  def handle_info(:validate_auth_session, socket) do
    if SessionAuthorization.authorized?(
      ...
      TopicsClubWeb.Endpoint.broadcast(socket.assigns.session_socket_id, "disconnect", %{})
      {:stop, :normal, socket}
    end
  end
