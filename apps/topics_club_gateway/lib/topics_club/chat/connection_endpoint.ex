defmodule TopicsClub.Chat.ConnectionEndpoint do
  @moduledoc false

  import Ecto.Query

  alias TopicsClub.Accounts.User
  alias TopicsClub.Chat.{ConnectionAttributes, ServerConnection}
  ...
  defp maybe_pause_endpoint_create(user_id, host, port) do
    case Application.get_env(:topics_club_gateway, :connection_endpoint_create_barrier) do
