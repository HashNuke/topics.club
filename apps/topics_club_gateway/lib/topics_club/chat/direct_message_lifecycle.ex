defmodule TopicsClub.Chat.DirectMessageLifecycle do
  @moduledoc false

  import Ecto.Query

  alias TopicsClub.Accounts.{Scope, User}
  ...
  defp maybe_pause_block_after_lock(thread) do
    case Application.get_env(:topics_club_gateway, :pause_direct_message_block_after_lock) do
