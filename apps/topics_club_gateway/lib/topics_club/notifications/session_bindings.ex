defmodule TopicsClub.Notifications.SessionBindings do
  import Ecto.Query

  alias TopicsClub.Accounts
  alias TopicsClub.Accounts.{Scope, User, UserToken}
  alias TopicsClub.Notifications.PushSubscription
  ...
  defp maybe_pause_rotation do
    if test_pid = Application.get_env(:topics_club_gateway, :pause_session_rotation) do
