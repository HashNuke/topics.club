defmodule TopicsClub.Notifications.PushSubscription do
  use Ecto.Schema
  import Ecto.Changeset

  alias TopicsClub.Accounts.{User, UserToken}

  schema "push_subscriptions" do
    field :installation_id, :string
    field :endpoint, TopicsClub.Encrypted.Binary, redact: true
    field :endpoint_hash, :binary, redact: true
    field :p256dh, TopicsClub.Encrypted.Binary, redact: true
    field :auth, TopicsClub.Encrypted.Binary, redact: true
  ...
  defp validate_endpoint(:endpoint, endpoint) do
    case URI.parse(endpoint) do
      ...
      when is_binary(host) and host != "" ->
        if TopicsClub.Notifications.WebPush.public_host_syntax?(host),
          do: [],
