defmodule TopicsClub.Accounts do
  @moduledoc """
  ...
  alias TopicsClub.Accounts.{User, UserToken, UserNotifier}
  ...
  See `TopicsClub.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `TopicsClub.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  defp maybe_pause_session_reset do
    if test_pid = Application.get_env(:topics_club_gateway, :pause_session_reset) do
