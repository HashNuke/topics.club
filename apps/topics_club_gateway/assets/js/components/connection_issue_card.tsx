...
export default function ConnectionIssueCard({issue, onEditServer, onReconnectServer, server}: ConnectionIssueCardProps) {
  return (
    <section
      ...
      <div className="p-4 sm:p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1.5 text-sm leading-6 text-amber-50/75">{issue.summary}</p>
          </div>
        </div>
        ...
        <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
          ...
          <button
            ...
            className="min-h-11 rounded-lg bg-amber-200 px-4 py-2 text-sm font-semibold text-amber-950 transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-100 sm:min-h-0"
