...
export default function LeftSidebar(props: LeftSidebarProps) {
  ...
  return (
    <aside className={["min-h-0 border-r border-white/6 bg-[var(--app-sidebar)]", mobile ? "flex min-h-0 flex-1 flex-col border-r-0" : "hidden lg:flex lg:flex-col"].join(" ")}>
      <div className="flex h-14 shrink-0 items-center justify-between border-b border-white/6 px-3">
      ...
      <nav className="app-scrollbar min-h-0 flex-1 overflow-y-auto overscroll-contain px-2.5 py-3" aria-label="Joined topics">
      ...
      <div className="shrink-0 border-t border-white/6 p-2.5">
        <div className="flex items-center gap-2.5 rounded-lg border border-white/5 bg-white/3 p-1.5">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-1.5 text-[11px] text-white/40"><span className="size-1.5 rounded-full bg-emerald-300" aria-hidden="true" />connected</div>
          </div>
        </div>
      </div>
