defmodule TopicsClub.Irc.Session.CommandExecution do
  @moduledoc false
  ...
  alias TopicsClub.Irc.{CommandRegistry, ConnectionLock}
  alias TopicsClub.Irc.Session.{CommandExecutionError, CommandLifecycle, PendingEchoes, Targets}
