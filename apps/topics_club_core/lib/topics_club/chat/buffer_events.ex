defmodule TopicsClub.Chat.BufferEvents do
  @moduledoc false
  ...
  alias TopicsClub.InternalEvent.Data
  ...
  defp maybe_pause_direct_message_thread_broadcast(thread) do
    case Application.get_env(:topics_club_core, :pause_direct_message_thread_broadcast) do
  ...
  defp maybe_pause_direct_message_closed_broadcast(thread) do
    case Application.get_env(:topics_club_core, :pause_direct_message_closed_broadcast) do
      {pid, revision} when is_pid(pid) and revision == thread.mutation_revision ->
