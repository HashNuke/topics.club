defmodule IrcpipeWeb.EngineClientTestAdapter do
  @moduledoc false
  ...
  def request(request, timeout) do
    test_pid = Application.fetch_env!(:ircpipe_core, :engine_client_test_pid)
    send(test_pid, {:engine_client_request, request, timeout})

    case Application.get_env(:ircpipe_core, :engine_client_test_reply, :ok) do
      :ok ->
